...
//
// 用法：
//   node scripts/lint-hardcoded-base.mjs           全掃 docs/**/*.{md,vue}
//   node scripts/lint-hardcoded-base.mjs --strict  發現即 exit 1（CI 阻擋）
//
// 偵測規則：
...
//
// 設計目標：non-blocking 訊號（預設 exit 0），CI 看到 warning 但不擋 build。
// 在 --strict 模式下會 exit 1，可選擇接進 ci.yml 變成阻擋條件。
