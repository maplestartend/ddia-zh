...
<div class="ddia-part-header">
  <div class="ddia-part-header-title">
    <Icon name="dataset" :size="22" filled :style="{ color: 'var(--brand-500)' }" />
    <div>
      <h2>Part I · 資料系統基礎</h2>
...
<div class="ddia-part-header">
  <div class="ddia-part-header-title">
    <Icon name="hub" :size="22" filled :style="{ color: 'var(--brand-500)' }" />
    <div>
      <h2>Part II · 分散式資料</h2>
...
<div class="ddia-part-header">
  <div class="ddia-part-header-title">
    <Icon name="waves" :size="22" filled :style="{ color: 'var(--brand-500)' }" />
    <div>
      <h2>Part III · 衍生資料</h2>
