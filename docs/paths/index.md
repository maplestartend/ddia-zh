...
不同角色 / 不同目標的人，閱讀順序與重點不同。下面三條路徑都是經過設計、可以省下你 30% 時間的閱讀地圖。
...
完整自評題與對應章節 → [Part 0 入口](/part-0/)。已熟悉以上題目？直接從下方路徑挑你的角色開始。
:::
...
## 兩週速成：只挑必讀 {.role-h2 .icon-bolt}

如果你只有兩週，**先確認你是否屬於下列其中一群**：
