...
### CQRS <span class="glossary-star" title="面試常考">★</span> {#cqrs}
**中文**：命令查詢職責分離
...
### Event-Driven Workflow <span class="glossary-star" title="面試常考">★</span> {#event-driven-workflow}
**中文**：事件驅動工作流
...
### Exactly-Once Semantics <span class="glossary-star" title="面試常考">★</span> {#exactly-once}
**中文**：恰好一次語意
...
### Idempotent <span class="glossary-star" title="面試常考">★</span> {#idempotent}
**中文**：冪等
...
### Linearizability <span class="glossary-star" title="面試常考">★</span> {#linearizability}
**中文**：線性一致
...
### Quorum <span class="glossary-star" title="面試常考">★</span> {#quorum}
**中文**：法定人數
...
### Saga <span class="glossary-star" title="面試常考">★</span> {#saga}
**中文**：Saga 模式 / 補償交易
