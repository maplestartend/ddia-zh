...
- 標記 <span class="glossary-star" title="面試常考">★</span> 的條目是**面試常考**，建議優先精讀。
:::

::: tip 「面試常考 ★」標記是什麼
帶有 <Badge type="warning" text="面試常考 ★" /> 標記的詞彙、是 senior backend / SRE 面試 80% 會被問到的核心概念。面試前 1-2 小時複習這 7-10 條、勝過讀整本詞彙表。**這不是「全部讀完」的替代品、是時間壓力下的優先級**。
:::
