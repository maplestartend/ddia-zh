...
export const GLOSSARY: readonly GlossaryEntry[] = [
  ...
  { term: 'consistent-prefix-reads', slug: 'consistent-prefix-reads', chinese: '一致前綴讀', english: 'Consistent Prefix Reads',
    ...
    chapter: '/part-2/ch05-replication' },
  { term: 'serialization-failure', slug: 'serialization-failure', chinese: '序列化失敗', english: 'Serialization Failure (SQLSTATE 40001)',
    shortDef: 'PG/Oracle 在 SI/SER 偵測到並發衝突主動 abort 第二個交易拋出的 SQLSTATE。應用層必須 catch + retry 整個 transaction。注意：與資料編碼的 Serialization 是完全不同的東西。',
    chapter: '/part-2/ch07-transactions', aliases: ['40001'] },
